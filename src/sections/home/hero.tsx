...
export const Hero = () => {
  ...
  return (
    ...
    >
      <div className="container max-md:h-screen relative max-sm:pt-32 max-sm:pb-32 px-4 overflow-hidden border sm:px-6  sm:py-8 rounded-b-3xl sm:rounded-3xl  mx-auto z-10 flex min-h-[80vh] flex-col bg-[radial-gradient(ellipse_at_top,var(--background)_0%,var(--background)_120%)] lg:justify-center">
